<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="editarPaciente.aspx.cs" Inherits="CRUD.editarPaciente" %>
    ...
    <body>
        ...
        <table style="width: 50%; height: 50%; margin: 20px auto; text-align:center"" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="btnGuardar" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" runat="server" Text="Guardar" OnClick="btnGuardar_Click" />
