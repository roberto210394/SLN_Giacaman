<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="editarUsuario.aspx.cs" Inherits="CRUD.Usuarios.editarUsuario" %>
    ...
    <div class="contenedor_tablas">
        <table style="width: 50%; height: 50%; margin: 50px auto; text-align: center" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
            ...
            <tr>
                ...
                <td style="text-align: center">
                    <asp:TextBox ID="txtPNombre" runat="server" MaxLength="50"></asp:TextBox>
                    <br />
            ...
            <tr>
                ...
                <td style="text-align: center">
                    <asp:DropDownList ID="ddlRolUsuario" runat="server" Width="150px" DataTextField="descripcion" DataValueField="id" DataSourceID="SqlDataSource2"></asp:DropDownList>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="text-align: center">
                    <asp:DropDownList ID="ddEspecialidad" runat="server" Width="150px" DataTextField="descripcion" DataValueField="id" DataSourceID="SqlDataSource1"></asp:DropDownList>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="text-align: center">
                    <asp:Button ID="btnAgregar" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" runat="server" Text="Agregar" />
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
